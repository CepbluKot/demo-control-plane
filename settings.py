...
class Settings(BaseSettings):
    ...
    CONTROL_PLANE_UI_LOGS_SUMMARY_AUTO_SHRINK_ON_400: bool = True
    CONTROL_PLANE_UI_LOGS_SUMMARY_MIN_LLM_BATCH_SIZE: int = 20
    CONTROL_PLANE_UI_LOGS_SUMMARY_MAX_SHRINK_ROUNDS: int = 6
    # Structured REDUCE fan-in per group. Keep >=2 to ensure convergence.
    CONTROL_PLANE_UI_LOGS_SUMMARY_REDUCE_GROUP_SIZE: int = 2
    # Max chars for one structured summary passed into REDUCE node input.
    CONTROL_PLANE_UI_LOGS_SUMMARY_REDUCE_INPUT_MAX_CHARS: int = 40000
    CONTROL_PLANE_UI_LOGS_SUMMARY_MAP_WORKERS: int = 1
    CONTROL_PLANE_UI_LOGS_SUMMARY_MAX_RETRIES: int = -1
    CONTROL_PLANE_UI_LOGS_SUMMARY_LLM_TIMEOUT: int = 1200
    ...
    CONTROL_PLANE_UI_LOGS_SUMMARY_FINAL_STAGE_LLM_TIMEOUT: int = 1200
    CONTROL_PLANE_UI_LOGS_SUMMARY_FINAL_STAGE_CONTEXT_MAX_CHARS: int = 120000
    CONTROL_PLANE_HTTP_TIMEOUT_SECONDS: int = 1200
